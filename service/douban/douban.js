var handle,
    ...
    _fn;
  URL = {
    moveList: 'https://api.douban.com/v2/movie/',
    movieDetail: 'https://api.douban.com/v2/movie/subject/',
    staffDetail: 'https://api.douban.com/v2/movie/celebrity/'
  }
  // 电影类型
  LISTTYPE = {
    1: 'in_theaters', // 正在热映
  ...
  handle = {
    getMovieList: function(type, callback) {
      var url = URL.moveList + LISTTYPE[type]
      _fn.getData({
        url: url
      }, callback)
    },
    ...
    getStaffDetail: function(id, callback) {
      var url = URL.staffDetail + id
      _fn.getData({
        url: url
      }, callback)
    }
  ...
  _fn = {
    getData: function(param, callback) {
      wx.request({
        ...
        header: {
          'Content-Type': 'json' // 之前为application/json  报400错误。
        },
        success: function(e) {
          callback(e.data)
        },
